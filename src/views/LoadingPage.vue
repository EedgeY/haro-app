<template>
  <div class="overscroll-none animate-pulse">
    <div class="flex m-5">
      <div class="flex justify-center items-center gap gap-9 m-4">
        <h1 class="text-3xl"><br /></h1>
        <a><br /></a>
        <a><br /></a>
      </div>

      <div class="my-1 w-80 items-cente mr-52"></div>
    </div>
    <!-- ========== END HEADER ========== -->
    <div class="flex justify-between">
      <br />
      <div class="flex flex-col bg-slate-50 mr-52 p-5">
        <div class="flex justify-center items-center rounded-lg mb-3">
          <a>日報</a>
        </div>
        <div class="flex gap-5">
          <button
            type="button"
            class="transform cursor-pointer rounded-lg bg-blue-600 px-6 py-2 text-xs font-medium capitalize tracking-wide text-white transition-colors duration-300 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
            disabled
          >
            <svg
    ...
    <div class="flex mx-20 justify-center bg-slate-100">
      <form class="flex w-full gap-1 p-4">
        ...
        <div class="flex flex-col w-96">
          <br />
          <label class="px-2 py-1 text-xs font-medium text-gray-500 uppercase"
            ><br
          /></label>
          ...
          <div class="overflow-auto mx-20 h-[500px]">
            ...
            >
              ...
              <tbody class="divide-y divide-gray-200">
                <tr class="bg-slate-50 flex justify-center items-center h-20">
                  <th class="flex justify-center items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="animate-spin icon icon-tabler icon-tabler-loader-2"
                      width="36"
                      height="36"
                      viewBox="0 0 24 24"
                      stroke-width="1.5"
...
const dummyData = ref(new Array(5).fill(null)); // 例として5行のダミーデータ
onMounted(() => {
